      ...
      <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 sm:py-8 lg:px-8 lg:py-5">
        <div className="grid grid-cols-2 gap-6 gap-y-8 lg:grid-cols-4 lg:gap-8 lg:gap-y-10">
          ...
          <div>
            ...
            <div className="space-y-3 text-xs text-slate-400 sm:space-y-4 sm:text-sm">
              <div className="flex items-start gap-2.5 sm:gap-3">
                ...
                <p className="leading-5 sm:leading-6">
                  ...
                  Office No-03, near Akurdi Railway Station Road, Gurudwara Colony,
                  Nigdi, Pune, Pimpri-Chinchwad, Maharashtra 411035
                </p>
              </div>
              ...
              <div className="flex items-start gap-2.5 sm:gap-3">
                ...
                />
                <p className="leading-5 sm:leading-6">
                  <span className="font-semibold text-slate-300">Work:</span>{" "}
