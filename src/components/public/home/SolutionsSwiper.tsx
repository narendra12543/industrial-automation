          ...
          >
            {slides.map((slide) => (
              <SwiperSlide key={slide.title}>
                <div className="relative h-[420px] overflow-hidden sm:h-[480px] lg:h-[580px]">
                  <Image
                    src={slide.image}
                    alt={slide.title}
                    fill
                  ...
                  {/* Content */}
                  <div className="absolute inset-0 flex items-end pb-10 sm:pb-12 lg:pb-36">
                  ...
                  {/* Custom controls: dot pagination with live progress */}
          <div className="mt-[550px] flex items-center justify-center gap-2.5">
            {slides.map((slide, i) => (
              <button
                key={slide.title}
                onClick={() => goTo(i)}
